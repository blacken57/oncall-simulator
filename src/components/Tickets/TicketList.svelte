...
<style>
  ...
  h2 { margin: 0; font-size: 1.5rem; letter-spacing: 0.1em; }
  
  .stats { display: flex; gap: 1.5rem; font-size: 0.9rem; font-weight: bold; }
  .stat { color: #f87171; }
  ...
  .ticket-card.open { border-left-color: #f87171; }
  .ticket-card.investigating { border-left-color: #fbbf24; }
  .ticket-card.resolved { border-left-color: #4ade80; opacity: 0.6; }
  ...
  h4 { margin: 0 0 0.5rem 0; font-size: 0.95rem; color: #eee; }
  p { margin: 0 0 1rem 0; font-size: 0.8rem; color: #888; line-height: 1.4; }
